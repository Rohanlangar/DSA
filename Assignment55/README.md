...
- Query by roll number (primary), search by name, filter by CGPA, list applications per student, list placed students
- Record company drives and student applications
- Support bulk imports and exporting
