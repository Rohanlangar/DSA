...
## Features
- **Insert Product**  
  Adds a new product to the tree with its details.

- **Display All Products (Inorder)**  
  Lists products in alphabetical order of their names.

- **Delete Product by Code**  
  Removes a specific product using its unique product code.

- **Delete All Expired Products**  
  Deletes products whose expiration date is earlier than the current date.
...
## Tree Organization
- BST is organized by **product name**.  
- Left child → Product name is lexicographically smaller  
- Right child → Product name is lexicographically larger  
