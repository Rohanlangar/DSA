...
- **Key** → Employee ID  
- **Value** → Employee Record (Name, Dept, Salary)  

---

## **Hash Function Used: Mid-Square Method**

1. Square the key  
2. Extract the middle digits  
3. Apply MOD with table size  
...
This method reduces clustering and distributes keys evenly.

---

### **Insert Employee**
1. Read employee details  
2. Compute index using mid-square hash  
3. If slot empty → insert  
4. Else → move to next index using linear probing  
5. Stop when empty or deleted slot found  

### **Search Employee**
1. Compute hash index  
2. Linearly probe until:
   - Employee ID found → return index  
   - Empty slot found → record not present  
...
### **Display Hash Table**
Show index, state, and employee details.
