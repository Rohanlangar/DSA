...
### Theory :
A **Binary Search Tree (BST)** is a hierarchical data structure that allows efficient searching, insertion, and sorting of data.

Each node has two children:
- The **left** child contains keys smaller than the parent node.
- The **right** child contains keys greater than the parent node.

When the inorder traversal is performed, the data is displayed in ascending order of keys.
