# Assignment no : 14
### Title : Implement a program to represent sets using linked lists and perform set operations like union, intersection, and symmetric difference for student sports preferences.

#### Theory :
**Set Operations using Linked Lists** is a practical application where we represent mathematical sets using linked list data structure. Each node contains a unique element, and we can perform various set operations.

**Key Set Operations:**
1. **Union (A ∪ B)** - Contains all elements from both sets
2. **Intersection (A ∩ B)** - Contains elements common to both sets  
3. **Symmetric Difference (A ⊕ B)** - Contains elements in either set but not in both
4. **Complement** - Elements not in the given set (relative to universal set)
...
```L
inkedList intersection(LinkedList& A_rrl, LinkedList& B_rrl) {
...
https://drive.google.com/file/d/17EN4mC_PSQCiezIEynH3O6tfx0YwsfGd/view?usp=drive_link