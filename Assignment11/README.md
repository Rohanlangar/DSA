# Assignment no : 11
### Title : Implement a program to manage membership of a club using singly linked list. Store student PRN and Name. Write functions to:
1. Add and delete the information of President (beginning of the list)
2. Add and delete the information of Secretary (end of the list)  
3. Add and delete the information of Member (anywhere in the list)
4. Display total number of members
5. Display the information of all members
6. Sort the list based on PRN
7. Reverse the list
8. Concatenate two lists

#### Theory :
**Singly Linked List** is a linear data structure where each element (node) contains data and a pointer to the next node. Unlike arrays, linked lists don't store elements in contiguous memory locations.

**Key Operations:**
1. **Insertion at Beginning (President)** - Add new node at the start, update head pointer
2. **Insertion at End (Secretary)** - Traverse to last node, add new node at the end
3. **Deletion from Beginning** - Remove first node, update head to next node
4. **Deletion from End** - Traverse to second last node, remove last node
5. **Search** - Traverse the list to find a specific element
6. **Sort** - Use bubble sort algorithm to arrange nodes in ascending order
7. **Reverse** - Change the direction of pointers to reverse the list
8. **Concatenation** - Connect the end of first list to the beginning of second list
...
https://drive.google.com/drive/folders/1yuCcfUIQcRzBhFUamSFgluqHoIkXTQDf?usp=drive_link